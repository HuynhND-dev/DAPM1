...
<head>
    ...
    <title>Đặt lại mật khẩu FINDJOBVN</title>
    ...
    <tr>
        <td>
            <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    ...
                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                       Vì vấn đề bảo mật, chúng tôi không cung cấp cho bạn mật khẩu cũ hoặc tự tạo mật khẩu mới cho bạn. Để đặt lại mật khẩu, vui lòng bấm vào nút bên dưới để mở liên kết tới trang đổi mật khẩu
                                    </p>
                ...
                <tr>
                    <td style="text-align:center;">
                        <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>http://findjob.vn</strong></p>
                    </td>
                </tr>
                <tr>
                    <td style="height:80px;">&nbsp;</td>
